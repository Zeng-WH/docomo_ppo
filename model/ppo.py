...
class PPOTrainer:
    ...
    def batched_forward_pass(self, model_input, gen_len):
        ...
        for i in range(int(self.ppo_params['batch_size']/fbs)):
            ...
            model_output = self.model(m_input)
            ...
            ref_model_output = self.ref_model(m_input.cuda(device='cuda:1'))
            ref_logits = ref_model_output['logits']
            ref_logits = ref_logits.cuda(device='cuda:0')
